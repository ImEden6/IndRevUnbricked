...
public final class HahaManager {
    ...
    public static String getFact() {
        ...
        return (String)splashLines.get((int)(System.currentTimeMillis() % (long)splashLines.size()));
    }
}

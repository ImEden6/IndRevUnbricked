...
public final class DashGlBlendState {
    ...
    public DashGlBlendState(int srcRgb, int srcAlpha, int dstRgb, int dstAlpha, int mode, boolean separateBlend, boolean blendDisabled) {
        this.srcRgb = srcRgb;
    ...
    public DashGlBlendState(GlBlendStateAccessor blendStateAccess) {
        this(blendStateAccess.getSrcRgb(), blendStateAccess.getSrcAlpha(), blendStateAccess.getDstRgb(), blendStateAccess.getDstAlpha(), blendStateAccess.getMode(), blendStateAccess.getSeparateBlend(), blendStateAccess.getBlendDisabled());
    }

    public DashGlBlendState(class_277 blendState) {

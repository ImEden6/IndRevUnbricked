...
public enum Option {
    ...
    CACHE_SPRITES("cache.sprite", "Caches Sprite/Atlases which allows the game to load textures extremely fast"),
    ...
    private Option(String mixinContains, String description) {

package me.mervyn.indrev.items.misc

import me.mervyn.indrev.FabricRecipeRemainder
...
class IRCraftingToolItem(settings: Settings) : Item(settings), FabricRecipeRemainder {
    override fun getRemainder(stack: ItemStack?, craftingInventory: RecipeInputInventory?, playerEntity: PlayerEntity?): ItemStack? {
